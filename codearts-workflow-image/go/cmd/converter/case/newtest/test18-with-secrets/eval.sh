#!/bin/bash
# Eval script for test18-with-secrets
...
echo "=========================================="
echo "EVAL: test18-with-secrets"
echo "=========================================="

# Configuration
TEST_DIR="${WORKSPACE}"
SECRET_NAME="pipeline-secret-test-secrets-456-1f62ad9a11e5438c"
...
echo ""
echo "=========================================="
echo "PASS: test18-with-secrets - All validations passed"
echo "=========================================="
exit 0