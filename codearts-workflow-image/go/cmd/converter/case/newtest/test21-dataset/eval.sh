#!/bin/bash
# Eval script for test21-dataset
...
if echo "$workflow_logs" | grep -q "Dataset mount test"; then
...
if echo "$workflow_crd" | grep -q "claimName: testorg-testrepo-test15"; then
    echo "PASS: Shared PVC claim name found (mapped from test21 to test15)"
else
...
echo ""
echo "=========================================="
echo "PASS: test21-dataset - All validations passed"
echo "=========================================="
exit 0