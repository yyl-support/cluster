#!/bin/bash
# Eval script for test8-git-clone
...
if echo "$workflow_crd" | grep -q "jobPRID: \"700\""; then
    echo "PASS: jobPRID label '700' found in CRD"
else
    echo "FAIL: jobPRID label '700' NOT found in CRD"
    exit 1
fi
...
echo ""
echo "=========================================="
echo "PASS: test8-git-clone - All validations passed"
echo "=========================================="
exit 0
