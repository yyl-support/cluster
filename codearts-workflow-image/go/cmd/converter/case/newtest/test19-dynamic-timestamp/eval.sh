#!/bin/bash
# Eval script for test19-dynamic-timestamp
...
echo "=========================================="
echo "EVAL: test19-dynamic-timestamp"
echo "=========================================="
...
if echo "$workflow_logs" | grep -q "Using API token:" && echo "$workflow_logs" | grep -q "secret-api-token-19"; then
...
if echo "$workflow_logs" | grep -q "Using DB password:" && echo "$workflow_logs" | grep -q "secret-db-password-19"; then
...
echo ""
echo "=========================================="
echo "PASS: test19-dynamic-timestamp - All validations passed"
echo "=========================================="
exit 0